<div>
    ...
    <div class="relative">
        <div class="flex justify-between items-center mb-1">
            ...
            <div class="flex items-center space-x-1">
                ...
                <div x-data="{ init() {
                    ...
                    <x-jet-secondary-button variant="success" wire:click="export"><span>{{ __('Export') }}</span>
                        <x-icons.excel class="ml-2" /></x-jet-secondary-button>
                </div>
                @endif
        ...
        <div class="rounded-lg shadow-lg bg-white max-w-screen overflow-x-scroll mt-2">
