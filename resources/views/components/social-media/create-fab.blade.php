<div x-data='{ open : false}' class="fixed right-4 bottom-4 lg:right-8 lg:bottom-8 z-40">
    <div class="flex flex-col space-y-4 mb-4 z-40 origin-bottom" x-cloak x-show='open'
        x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 transform scale-50"
        ...
        <x-jet-button x-on:click='open = !open' class="py-4 lg:py-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-0 lg:mr-2" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <x-jet-button class="py-4 lg:py-2">
            <svg class="h-5 w-5 mr-0 lg:mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <span class="hidden sm:inline-block">{{ __('Quote') }}</span>
        </x-jet-button>
        <x-jet-button class="py-4 lg:py-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-0 lg:mr-2" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
            ...
            <span class="hidden sm:inline-block">{{ __('Image') }}</span>
        </x-jet-button>

    </div>
    <x-jet-button x-on:click='open = !open'
        class="rounded-full py-4 lg:py-2 bg-indigo-200 text-indigo-700 border border-indigo-700 hover:bg-indigo-700 hover:text-indigo-100">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-0 lg:mr-2" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
