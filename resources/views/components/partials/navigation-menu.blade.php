<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="py-1 border-t border-gray-200">
            @guest
                <div class="space-y-1">
                    <x-jet-responsive-nav-link href="{{ route('explore.index') }}"
                    ...
                    <x-jet-responsive-nav-link href="{{ route('shop.index') }}"
                    ...
                    <x-jet-responsive-nav-link class="flex items-center" href="{{ route('login') }}"
                    ...
                    <x-jet-responsive-nav-link class="flex items-center" href="{{ route('register') }}"
            ...
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-jet-responsive-nav-link href="{{ route('feed.index') }}"
                    ...
                    <x-jet-responsive-nav-link href="{{ route('connection.index') }}"
                        :active="request()->routeIs('connection.index')">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
