<footer class="text-gray-600 body-font">
    <div
        ...
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                <x-jet-application-mark class="h-5 w-6" />
                <span class="ml-3 text-xl">TaxGlobe<sup>Professionals</sup></span>
            </a>
            <p class="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
        </div>
        <div class="flex-grow flex flex-row md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div class="flex-auto w-full px-4">
                ...
                <nav class="list-none mb-10">
                    <li>Contact: +91 999-999-9999</li>
                    <li>Email: info@taxglobe.in</li>
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">© {{ date('Y') }} TaxGlobe Professionals —
                <a href="//kubre.in" target="_blank" rel="noopener noreferrer" class="text-gray-600 ml-1"
                    target="_blank">
