<div x-data='{ open : false }' class="relative flex">
    <div class="flex flex-row -m-16 md:-ml-32 p-2 rounded-full justify-center absolute space-x-4 bottom-12 md:-bottom-20 bg-white shadow-lg mb-4 z-40 origin-bottom"
        ...
        <x-jet-button class="py-4 lg:py-2"
            ...
            <svg class="h-5 w-5 mr-0 md:mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
